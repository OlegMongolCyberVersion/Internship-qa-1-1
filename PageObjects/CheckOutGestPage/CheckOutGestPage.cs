...
{
    internal class CheckOutGestPage : WebPage
    {
        public CheckOutGestPage(IWebDriver driver)
            : base(driver)
        {
            Map = new Map(driver);
        ...
        protected override string Url => "http://demowebshop.tricentis.com/login/checkoutasguest?returnUrl=%2Fcart";
